...
// pub const parseRules = std.EnumArray(TokenType, ParseRule).initDefault(null, .{
//     .LPAREN = ParseRule{ .precedence = .CALL, .prefix = &grouping, .infix = &call },
//     .RPAREN = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .LBRACE = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .RBRACE = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .COMMA = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .DOT = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .MINUS = ParseRule{ .precedence = .TERM, .prefix = &unary, .infix = &binary },
//     .PLUS = ParseRule{ .precedence = .TERM, .prefix = null, .infix = &binary },
//     .STAR = ParseRule{ .precedence = .FACTOR, .prefix = null, .infix = &binary },
//     .FSLASH = ParseRule{ .precedence = .FACTOR, .prefix = null, .infix = &binary },
//     .BSLASH = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .SEMICOLON = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .BANG = ParseRule{ .precedence = .NONE, .prefix = &unary, .infix = null },
//     .BANG_EQUAL = ParseRule{ .precedence = .EQUALITY, .prefix = null, .infix = &binary },
//     .EQUAL = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .EQUAL_EQUAL = ParseRule{ .precedence = .EQUALITY, .prefix = null, .infix = &binary },
//     .LESS = ParseRule{ .precedence = .COMPARISON, .prefix = null, .infix = &binary },
//     .LESS_EQUAL = ParseRule{ .precedence = .COMPARISON, .prefix = null, .infix = &binary },
//     .GREATER = ParseRule{ .precedence = .COMPARISON, .prefix = null, .infix = &binary },
//     .GREATER_EQUAL = ParseRule{ .precedence = .COMPARISON, .prefix = null, .infix = &binary },
//     .IDENTIFIER = ParseRule{ .precedence = .NONE, .prefix = &variable, .infix = null },
//     .STRING = ParseRule{ .precedence = .NONE, .prefix = &string, .infix = null },
//     .NUMBER = ParseRule{ .precedence = .NONE, .prefix = &number, .infix = null },
//     .AND = ParseRule{ .precedence = .AND, .prefix = null, .infix = &_and },
//     .CLASS = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .ELSE = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .FALSE = ParseRule{ .precedence = .NONE, .prefix = &literal, .infix = null },
//     .FOR = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .FUN = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .IF = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .NIL = ParseRule{ .precedence = .NONE, .prefix = &literal, .infix = null },
//     .OR = ParseRule{ .precedence = .OR, .prefix = null, .infix = &_or },
//     .RETURN = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .SUPER = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .THIS = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .TRUE = ParseRule{ .precedence = .NONE, .prefix = &literal, .infix = null },
//     .VAR = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .COSNT = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .WHILE = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .ERROR = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
//     .EOF = ParseRule{ .precedence = .NONE, .prefix = null, .infix = null },
// });
